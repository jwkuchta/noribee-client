...
module.exports = (function() {
    ...
    return getToken()
      ...
      .then(token => {
        const managementClient = new ManagementClient({
          ...
          token,
          audience: `https://${process.env.REACT_APP_CLIENT_DOMAIN}/api/v2/`
        });
  ...
  function getToken() {
    ...
    const url = `https://${process.env.REACT_APP_CLIENT_DOMAIN}/oauth/token`;
  ...
  function getClient(clientId = null) {
    if (!clientId) clientId = process.env.REACT_APP_CLIENT_ID;
